...
create or replace TABLE POC_DB.LA_POC_RAW.BRAND (
...
create or replace TABLE POC_DB.LA_POC_RAW.CATEGORY (
...
create or replace TABLE POC_DB.LA_POC_RAW.CONTACT (
...
create or replace TABLE POC_DB.LA_POC_RAW.CUSTOMER (
...
create or replace TABLE POC_DB.LA_POC_RAW.ORDERS (
...
create or replace TABLE POC_DB.LA_POC_RAW.ORDER_PRODUCT (
...
create or replace TABLE POC_DB.LA_POC_RAW.ORDER_STATUS (
...
create or replace TABLE POC_DB.LA_POC_RAW.PAYMENT_METHOD (
...
create or replace TABLE POC_DB.LA_POC_RAW.PAYMENT_STATUS (
...
create or replace TABLE POC_DB.LA_POC_RAW.PRICE (
...
create or replace TABLE POC_DB.LA_POC_RAW.PRODUCT (
...
create or replace TABLE POC_DB.LA_POC_RAW.SHIPPING (
...
create or replace TABLE POC_DB.LA_POC_RAW.SHIPPING_CARRIER (
	CARRIER_ID NUMBER(38,0) NOT NULL,
...
create or replace TABLE POC_DB.LA_POC_RAW.SHIPPING_STATUS (
